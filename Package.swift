...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "VoqalSDKBinary",
            url: "https://voqal-sdk-releases-eu.s3.eu-west-1.amazonaws.com/VoqalSDK-1.4.0.zip",
            checksum: "5273cf382ea3b80e24c9bfddb31d64e0ab977b67e35000cbf4c73fe6546a3273"
        ),
        .target(
            name: "VoqalSentry",
            dependencies: [
